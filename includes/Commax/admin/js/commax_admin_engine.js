$(document).ready(function() {
	...
	$( "#dialog-remove" ).dialog({
		...
		buttons: {
			"Confirm Remove": function() {
				$.post('include/commax_admin_processor.php?post_action=rem_comm&comm_rem_id='+current_rem_id, function(msg){
					if(msg.status){
	...
	$( "#dialog-approve" ).dialog({
		...
		buttons: {
			"Confirm approve": function() {
				$.post('include/commax_admin_processor.php?post_action=app_comm&comm_app_id='+current_app_id, function(msg){
					if(msg.status){
	...
	$('form.form_save_config').submit(function(e){
		e.preventDefault();
		$this = $(this);
		$.post('include/commax_admin_processor.php?post_action=save_cfg', $(this).serialize(), function(msg){
			if(msg.status){
