...
require str_replace('\\','/',dirname(__FILE__)) . "/commax.class.php";

class Ccommax_captcha extends Ccommax {
	...
	public function CreateCaptcha() {
		...
		//path to font:
		$fontpath = str_replace('\\','/',dirname(__FILE__)) . '/fonts/';
