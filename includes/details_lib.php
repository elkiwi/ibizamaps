...
<p class="priceTitle">'. $avPriceTrans.' / '; 
	...
	function langflag() {
		...
		$langFlags ='<a href="/es/'. $muniUrl . '/' . $typeUrl . '/' . $id . '.html"><img src="/ddtabmenufiles/media/en.gif" alt="Español" width="62" height="23" border="0" align="right" /></a>';	
...
function detailImages() {
	...
	} while ($row_hotels = mysql_fetch_assoc($hotels)); 
	...
	} while ($row_restaurants = mysql_fetch_assoc($restaurants)); 
...
} while ($row_Distances = mysql_fetch_assoc($Distances)); 
