  //<![CDATA[
	...
	function initialize() {
		...
		icon: icon.icon
		  ...
		  downloadUrl("/info_xmlparser.php?muni=" + muni + "&lang=" + lang + "&typeurl=" + typeurl + "", function(data) {
		  ...
		  for (var i = 0; i < markers.length; i++) {
			...
			var html = '<div style="width: 280px; margin-left: 10px;"><img src="/images/pages/' + id + '/th_image.jpg" align="right" style="padding:5px 0 0 5px;" /><br /><a href="/' + lang + '/' + muniurl + '/' + typeurl + '/' + id + '.html" ><b>' + name + '</b></a> <br/>' + address + '</div>'
