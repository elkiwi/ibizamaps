  //<![CDATA[
	...
	function initialize() {
		...
		icon: icon.icon
		  ...
		  downloadUrl("/island_xmlparser.php?lat=" + latitude + "&lng=" + longitude + "&lang=" + lang + "", function(data) {
		  ...
		  for (var i = 0; i < markers.length; i++) {
			...
			var html = '<div style="width: 280px; margin-left: 10px;"><a href="/' + lang + '/' + muniurl + '/' + typeurl + '/' + id + '.html" ><b>' + name + '</b></a> <br/>' + address + '</div>'
 ...
 //<img src="/images/pages/' + typeurl +'/' + id + '/th_image.jpg" align="right" style="padding:5px 0 0 5px;" /><br />
